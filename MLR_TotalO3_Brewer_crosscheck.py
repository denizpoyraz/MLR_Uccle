...
# print(predictors12m[0:3])
# print(list(predictors12m))
...
pl = [i * 100 for i in pl]
pl = [round(i, 3) for i in pl]
pl = dict(zip(list(predictors),pl))
# print('pl', pl)
print('param_list 20km',pl)
# print('predictors', predictors[0:3])
ple = regression_output['gls_results'].bse
ple = [i * 100 for i in ple]
ple = [round(i, 3) for i in ple]
ple = dict(zip(list(predictors),ple))
print('error_list 20km',ple)
...
#
#
# plt.savefig('/home/poyraden/Analysis/MLR_Uccle/Plots/Paper_Reviews/TO_anomaly_monthly.pdf')
# plt.savefig('/home/poyraden/Analysis/MLR_Uccle/Plots/Paper_Reviews/TO_anomaly_monthly.png')
# plt.savefig('/home/poyraden/Analysis/MLR_Uccle/Plots/Paper_Reviews/TO_anomaly_monthly.eps')
#
# plt.show()
# plt.close()
#
...
# ax.legend(loc='lower right', frameon=False, fontsize='small')
#
# plt.savefig('/home/poyraden/Analysis/MLR_Uccle/Plots/Paper_Reviews/TO_monthly.pdf')
# plt.savefig('/home/poyraden/Analysis/MLR_Uccle/Plots/Paper_Reviews/TO_monthly.png')
# plt.savefig('/home/poyraden/Analysis/MLR_Uccle/Plots/Paper_Reviews/TO_monthly.eps')
#
# plt.show()
# plt.close()
#
...
plotmlr_perkm(uccle12m.index,uY12m,regression_output12m['fit_values'],'Total O3 Monthly Means','TotalOzone_totalcolumnilt_yearly')
