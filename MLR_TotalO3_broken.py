...
# predictors = predictors.resample('Q').mean()
...
# uccle = uccle.resample('Q').mean()


uccle.rename(columns={'Unnamed: 0':'dateindex'}, inplace=True)
...
setu = set(uccle.dateindex.tolist())
...
uccle_pre = uccle.loc['1971':'1996']
uccle_post = uccle.loc['2000':'2018']
...
print('dateindex', uccle.index)
print('regression output', regression_output['fit_values'])
