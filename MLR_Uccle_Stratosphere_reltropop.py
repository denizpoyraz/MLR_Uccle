...
''' Code to apply different models to Stratosphere, remove is only needed for the NewPredictors, not for Extended ILT'''
...
pre_name = 'NewPredictors_Stratosphere_reltropop'
