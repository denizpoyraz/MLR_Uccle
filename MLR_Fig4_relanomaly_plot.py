...
uYra = uccle['10km_ds'].values
regression_output_relanomaly = mzm_regression(uX, uYra)
regression_output_relanomaly_noilt = mzm_regression(uX_noilt, uYra)
...
print('coeffcieints:')
print('enso', param_list_relanomaly['enso'], 'qboA', param_list_relanomaly['qboA'], 'qboB',  param_list_relanomaly['qboB'] )
print('solar',  param_list_relanomaly['solar'], 'AOD',  param_list_relanomaly['AOD'])
...
ax0.plot(uccle.dateindex, uccle['10km_ds'], label = 'Ozone relative anomalies at 10km of stratosphere', color = '#7f7f7f')
ax0.plot(uccle.dateindex, regression_output_relanomaly['fit_values'], label = 'Regressed natural variations + ILT trend', color = 'black')
ax0.plot(uccle.dateindex, regression_output_relanomaly_noilt['fit_values'], label = 'Regressed natural variations', color = '#1f77b4', linestyle = '--')
...
ax1.plot(uccle.dindex, regression_output_relanomaly['residual'], label = 'Residuals', color = 'black')
...
ax2.plot(predictors.dindex, predictors['enso']*param_list_relanomaly['enso'], label='ENSO', color = '#2ca02c')
...
ax3.plot(predictors.dindex, predictors['qboA']*param_list_relanomaly['qboA'], label = 'QBO1 (50 hPa)', color = '#9467bd')
ax3.plot(predictors.dindex, predictors['qboB']*param_list_relanomaly['qboB'], label = 'QBO2 (30 hPa)', color = '#ff7f0e')
...
ax4.plot(predictors.dindex, predictors['solar']*param_list_relanomaly['solar'], color = '#17becf', label = 'Solar')
...
ax5.plot(predictors.dindex, predictors['AOD']*param_list_relanomaly['AOD'], color = '#1f77b4', label = 'AOD')
