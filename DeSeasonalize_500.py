...
# DeBilt
# uccle = pd.read_csv('/home/poyraden/MLR_Uccle/Files/DeBilt_1km_monthlymean500.csv')
# IAGOS
uccle = pd.read_csv('/home/poyraden/MLR_Uccle/Files/IAGOS_1km_monthlymean500.csv')
...
for ir2 in range(nkm):  # per each km
    b = ir2 * 0.5
    alt[ir2] = str(b) + 'km'
    alt2[ir2] = str(b) + 'km_ds'
