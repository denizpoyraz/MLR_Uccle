...
def plotmlr_perkm(pX, pY, pRegOutput, pltitle, plname):
    ...
    plt.savefig('/home/poyraden/MLR_Uccle/Plots/Uccle_50years/Residuals/' + plname + '.pdf')
    plt.savefig('/home/poyraden/MLR_Uccle/Plots/Uccle_50years/Residuals/' + plname + '.eps')
    plt.close()
